...
public record EndpointNodeResolver(ActorNodeResolver aNodeRes, WorldNodeResolver wNodeRes) {
     ...
     *
     * <p>The stream may contain more than one node in two situations: either the endpoint is a target
     * endpoint and the target is a module (in which case, the module's non-platform components stand in
     * for the module), or the endpoint is a world (in which case, any of the parent's connection nodes
     * can appear).
     *
